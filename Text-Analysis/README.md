**Package Used:**
- ***Python:** snownlp, re, openai, tiktoken, csv*


Two methods of doing text analysis:

1- [NLP.py](https://github.com/JingwenSHI-Novae/Coding-Samples/blob/main/Text-Analysis/NLP.py): use SnowNLP to conduct (Chinese) text sentiment analysis
